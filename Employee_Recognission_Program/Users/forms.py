...
class SignupForm(forms.Form):
    ...
    username = forms.CharField(widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Username','label':'UserName'}),min_length=3, max_length = 20, required=False, label='Username:')
    first_name = forms.CharField(widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'First Name'}),min_length=3, max_length = 20, required=False , label="First Name:")
    last_name = forms.CharField(widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Last Name', 'label':'Last Name'}),min_length=3, max_length = 20, required=False, label = "Last Name:")
